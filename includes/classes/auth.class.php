	...
	function testa_user($s_usuario, $s_nivel, $s_nivel_desc, $permissao, $help=''){
		...
		if (!isset($_SESSION['s_logado']) || $_SESSION['s_logado'] == 0)
		{
			...
			if ($s_nivel>$permissao) //se o nível do usuário for maior do que a permissão necessária para o script..
			{
				...
				$this->saida =  "<table class='main-table-header' cellspacing='1' border='0' cellpadding='1' align='center' width='100%'>".//#5E515B
								"<tr>".
									"<td class='title' nowrap width='75%'>".$this->texto."</td>".
									"<td class='time' width='25%' nowrap>".TRANS(date("l")).",&nbsp;".(formatDate(date("Y/m/d H:i"), " %H:%M"))."".$help."</td>";
				$this->saida.= "</TR>".
						"</TABLE>";
			}
			print $this->saida;
