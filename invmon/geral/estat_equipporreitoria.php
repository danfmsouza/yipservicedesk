<?php 
  ...
  */session_start();
	...
	print "<TABLE border='0' cellpadding='5' cellspacing='0' align='center' width='80%' bgcolor='".$cor3."'>";
		...
		print "<tr><td width='80%' align='center'><b>Sistema em desenvolvimento pelo setor de Helpdesk  do <a href='http://www.yip.com.br' target='_blank'>Unilasalle</a>.</b></td></tr>";
		print "</TABLE>";
