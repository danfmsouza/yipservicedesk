  ...
  */session_start();
	...
	$linhasInst = mysql_num_rows($resultadoInst);
		...
		print "<TABLE border='0' cellpadding='5' cellspacing='0' align='left' width='80%' bgcolor='$cor3'>";
			...
			print "<TR><TD bgcolor='".$cor3."'><b>".TRANS('OCO_LOCAL')."</TD><TD bgcolor='".$cor3."'><b>".TRANS('MNL_CAD_EQUIP')."</TD><TD bgcolor='".$cor3."'><b>".TRANS('COL_QTD')."</TD><TD bgcolor='".$cor3."'><b>".TRANS('COL_PORCENTEGE')."</TD>";
